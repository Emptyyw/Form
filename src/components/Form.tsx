...
const Form: FC = () => {
  ...
  const isNotFirstStep = active !== Steps.First;
  const isNotFourthStep = active !== Steps.Fourth;
  const isFourthStep = active === Steps.Fourth;
    ...
    <Container size='md'>
      <form onSubmit={handleSubmit}>
        ...
        <Group justify='space-between' mt='xl'>
          ...
          {isNotFourthStep && <Button onClick={nextStep}>Next step</Button>}
          {isFourthStep && (
            <>
